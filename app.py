...
@app.route('/registerctrlcntr', methods=['GET', 'POST'])  # registration of a control centre
def registerctrlcntr():
    ...
    return render_template('registercntlcntr.html', form=form)
